...
class SearchState:
	def __init__( self, costMatrix, partialPath, bound):
		self.costMatrix = costMatrix
		self.partialPath = partialPath
		self.bound = bound

	def __lt__(self, other):
		return (self.bound / (len(self.partialPath)**2)) < (other.bound / (len(self.partialPath)**2))
...
class TSPSolution:
	...
	def __init__( self, listOfCities = None):
